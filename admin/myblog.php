...
if (mysqli_num_rows($result) > 0) {
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        echo "<td>
                        <a href='edit1.php?id=" . $row['id'] . "' class='edit_btn' style='color:green; margin-right:20px;'><i class='fas fa-pen' style='font-size:14px; margin-right:5px; color:green;'></i>Edit</a>
                        <a href='delete.php?id=" . $row['id'] . "' class='del_btn' style='color:red;'><i class='fas fa-trash' style='font-size:14px; margin-right:5px; color:red;'></i>Delete</a>
							  </td>";
        echo "</tr>";
    }
}
